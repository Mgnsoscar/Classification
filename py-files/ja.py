...
def load_dataset():
    ...
    with open("C:/Users/mgnso/PycharmProjects/Classification/classification2/datasets/iris-allspecies.txt") as csv_file:
...
def show_MSE_plots(train_dataset, test_dataset, features, alphas, num_iterations=10):
...
all_samples, all_labels = load_dataset()
train_dataset, test_dataset = split_dataset(all_samples, all_labels, split_index=2)
features = get_all_features()
...
#show_confusion_matrices(train_dataset, test_dataset, features, num_iterations=1, alpha=0.005)
